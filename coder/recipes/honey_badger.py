...
import textwrap
from commands.commands import HoneyBadgerFaultList
...
class HoneyBadger:
    ...
    def after_create(self):
        ...
        Help the user understand their honeybadger data:
        ...
        """.replace("<<CONTEXT>>", self.coder.context).replace("<<REQUIREMENTS>>", self.coder.requirements)
    ...
    def on_run(self, user):
        ...
        # TODO get functions
        functions = [HoneyBadgerFaultList.schema()]
